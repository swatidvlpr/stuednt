<%@ Page Title="" Language="C#" MasterPageFile="~/admin/Admin.master" AutoEventWireup="true" CodeFile="Incoming.aspx.cs" Inherits="admin_Incoming" %>
   ...
   <table   cellspacing="1" align="center" width="90%">
        <tr>
            <td align="left">
                Amount:</td>
            <td>
                <asp:TextBox ID="TextBox1" runat="server" Height="30px" Width="300px">00.00</asp:TextBox>
        ...
        <tr>
            <td align="center" colspan="4" Style="border:none;">
                <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" 
                    ...
                    onrowdeleting="GridView1_RowDeleting" Width="580px">
